...
void	rotate_right(t_game *game)
{
	...
	game->player.player_dir_x = old_dir_x * cos(-game->player.rot_speed) - game->player.player_dir_y * sin(-game->player.rot_speed);
	game->player.player_dir_y = old_dir_x * sin(-game->player.rot_speed) + game->player.player_dir_y * cos(-game->player.rot_speed);
	game->player.plane_x = old_plane_x * cos(-game->player.rot_speed) - game->player.plane_y * sin(-game->player.rot_speed);
